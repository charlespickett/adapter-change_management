 ...
 * @param {error} callback.error - The error property of callback.
 */
 sendRequest(sendCallOptions, callback) {
  // Initialize return arguments for callback
  let uri;
  if (sendCallOptions.query)
    uri = this.constructUri(sendCallOptions.serviceNowTable, sendCallOptions.query);
  else
    uri = this.constructUri(sendCallOptions.serviceNowTable);
  /**
  ...
  const requestOptions = {
    method: sendCallOptions.method,
    auth: {
      user: sendCallOptions.username,
      pass: sendCallOptions.password,
    },
    baseUrl: sendCallOptions.url,
    uri: uri,
  };
